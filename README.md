...
https://geocoding.geo.census.gov/geocoder/Geocoding_Services_API.html to get the coordinates (latitude and longitude) of an valid address and from https://api.weather.gov to get the forecast, respectively. Those web service are free and no API key or authentication needed.

The application needs Postgresql and Redis. The .env file needs to have following variables:

DB_USERNAME=[username for the database]<br />
DB_PASSWORD=[password for the database]<br />
DB_NAME=[name of the database]<br />
DB_HOST=[host of database]<br />
